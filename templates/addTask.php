    ...
    <div class="content">
      ...
      <main class="content__main">
        ...
        <form class="form"  action="/add.php" method="post" autocomplete="off" enctype="multipart/form-data">
          <div class="form__row">
            <label class="form__label <?php isset($errors['name']) ? "form__input--error" : ""; ?>" for="name">Название <sup>*</sup></label>
            
            <input class="form__input " type="text" name="name" id="name" value="<?= isset($_POST['name']) ? esc($_POST['name']) : ''; ?>" placeholder="Введите название">
          ...
          <div class="form__row">
            ...
            <select class="form__input form__input--select <?php isset($errors['project']) ? "form__input--error" : ""; ?>" name="project" id="project">
            <?php foreach ($projects as $project): ?>
          ...
          <div class="form__row">
            ...
            <input class="form__input form__input--date <?php isset($errors['date']) ? "form__input--error" : ""; ?>" type="text" name="date" id="date" value="<?= getPostVal('date') ?>" placeholder="Введите дату в формате ГГГГ-ММ-ДД">
