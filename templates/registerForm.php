  ...
  <main class="content__main">
    ...
    <form class="form" action="/register.php" method="post" autocomplete="off">
      ...
      <div class="form__row">
        ...
        <input class="form__input <?php if(isset($errors['password'])): ?>'form__input--error'<?php endif;?>" value="<?= isset($_POST['password']) ? ($_POST['password']) : ''; ?>" name="password" type="password" id="password" placeholder="Введите пароль">
